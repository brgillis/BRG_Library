...
private:
	...
	typedef std::tuple<angle_type,angle_type,flt_t,flt_t> position;
...
public:
	...
	template<typename T>
	lensing_correlation_function_estimator(T && D_bin_limits, const flt_t & z_buffer=0)
	...
	lensing_correlation_function_estimator(TR1 && D1_pos_list, TR2 && D2_pos_list,
			TM1 && R1_pos_list, TM2 && R2_pos_list, const flt_t & z_buffer=0)
