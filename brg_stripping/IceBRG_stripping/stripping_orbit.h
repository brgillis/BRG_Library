...
private:
	...
	mutable std::vector< IceBRG::stripping_orbit_segment > _orbit_segments_;
#endif
	...
	mutable std::vector< IceBRG::stripping_orbit_segment >::iterator _final_good_segment_;
#endif
	...
	void _pass_parameters_to_segment(
			...
			IceBRG::density_profile *segment_init_satellite=NULL,
			IceBRG::density_profile *segment_init_host=NULL,
	 ...
	 */
	const std::vector< IceBRG::stripping_orbit_segment >::iterator _final_good_segment() const;
...
public:
	 ...
	 * @return Int flag - zero for success, otherwise for error.
	 */
	const int get_quality_of_fit( double & Q, double * scale, double const & final_weight, const bool use_virial=false);
	/**
	 * Get a quality-of-fit estimate, comparing the calculated fmret to the comparison values and errors.
