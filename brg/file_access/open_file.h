...
inline void open_file_input( std::ifstream & stream, const std::string & name )
{
	stream.close();
	stream.clear();
...
inline void open_file_output( std::ofstream & stream, const std::string & name )
{
	stream.close();
	stream.clear();
...
inline void open_file_io( std::fstream & stream, const std::string & name )
{
	stream.close();
	stream.clear();
...
inline void open_file_append( std::ofstream & stream, const std::string & name )
{
	stream.close();
	stream.clear();
...
inline void open_bin_file_input( std::ifstream & stream, const std::string & name )
{
	stream.close();
	stream.clear();
...
inline void open_bin_file_io( std::fstream & stream, const std::string & name )
{
	stream.close();
	stream.clear();
...
inline void open_bin_file_output( std::ofstream & stream, const std::string & name )
{
	stream.close();
	stream.clear();
...
inline void open_bin_file_append( std::ofstream & stream, const std::string & name )
{
	stream.close();
	stream.clear();
