...
#define DEFINE_BRG_CACHE_2D_STATIC_VARS(class_name,init_min_1,init_max_1,init_step_1, \
	...
	std::vector< std::vector< flt_type > > brgastro::class_name::_results_;
...
protected:
	...
	const flt_type _calculate(const flt_type x_1, const flt_type x_2) const
	{
		return 0;
	}
...
public:
	...
	const BRG_UNITS get( const flt_type x_1, const flt_type x_2, const bool silent = false ) const
	{
