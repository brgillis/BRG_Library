...
#if (1)
brgastro::custom_unit_type<0,-2,0,0,0> brgastro::density_profile::Daccel( const distance_type & r ) const
{
	distance_type dr;
...
brgastro::distance_type brgastro::density_profile::rhmtot() const
{
...
brgastro::distance_type brgastro::density_profile::rhmvir() const
{
	// If cached, return the cached value
	if ( hmvir_cached )
...
brgastro::mass_type brgastro::density_profile::enc_mass( const distance_type & r ) const
{
	if ( value_of(r) == 0 )
	...
	mass_type out_params = brgastro::integrate_Romberg( func,min_in_params,
...
brgastro::time_type brgastro::period( const brgastro::density_profile *host,
